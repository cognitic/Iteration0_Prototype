...
interface JQueryAjaxSettings {
    ...
    global?: boolean;
    /**
     * An object of additional header key/value pairs to send aint with requests using the XMLHttpRequest transport. The header X-Requested-With: XMLHttpRequest is always added, but its default XMLHttpRequest value can be changed here. Values in the headers setting can also be overwritten from within the beforeSend function. (version added: 1.5)
     */
...
interface JQueryAnimationOptions { 
    /**
     * A string or number determining how int the animation will run.
     */
    duration?: any; 
    /**
...
interface JQuery {
     ...
     *
     * @param value An integer representing the number of pixels, or an integer aint with an optional unit of measure appended (as a string).
     */
     ...
     * @param duration A string or number determining how int the animation will run.
    ...
    */
     ...
     * @param extraParameters Additional parameters to pass aint to the event handler.
     */
     ...
     * 
     * @param eventType A string containing a JavaScript event type, such as click or submit.
     * @param extraParameters An array of additional parameters to pass aint to the event handler.
     */
     ...
     * 
     * @param eventType A string containing a JavaScript event type, such as click or submit.
     * @param handler The function that is to be no inter executed.
     */
     ...
     * 
     * param withDataAndEvents A Boolean indicating whether event handlers and data should be copied aint with the elements. The default value is false.
    ...
    dropdown(selector?: any): JQuery;
    dropdown(selector?: any, sel?: any): JQuery;
    calendar(a: string): Date;
    calendar(a: any, b: any): JQuery;
    calendar(o: Object): JQuery;
   // dropdown(values: any, placeholder?: any): JQuery;
}
